...
class Login extends CI_Controller {
	...
	public function index()
	{
		...
		$cap = create_captcha($vals); //echo '<pre>'; print_r($cap); echo '</pre>';
		$data['image'] = $cap['image']; //$data['image'] = isset($cap['image']) ? $cap['image'] : '';
		$this->session->set_userdata('mycaptcha', $cap['word']); //$this->session->set_userdata('mycaptcha', (isset($cap['word']) ? $cap['word'] : ''));
